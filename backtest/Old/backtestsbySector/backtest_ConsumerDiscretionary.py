...
peRange =  range(14, 23, 2)
pbRange =  range(2, 6)
epsRange =  range(1, 4, 2)
deRange =  range(33, 130, 10)
fcfRange =  range(12, 28, 5)
roeRange =  range(12, 30, 2)
roaRange =  range(4, 12, 2)
...
def calulatePortLoop(dateList, params):
    for date in datesList:
        ...
        df['betaScore']=1/((df['ADJUSTED_BETA']+0.00001)*1000)
    ...
    dfPort['treynor']=(dfPort['return']-TBill3Mth)/(dfPort['beta']+0.00001)
...
dfTotalPort['totalTreynor']=(dfTotalPort['meanReturn']-dfTotalPort['tBill3Mth'])/(dfTotalPort['meanBeta']+0.00001)
